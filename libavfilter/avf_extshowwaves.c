...
static const AVOption extshowwaves_options[] = {
    ...
    { "linewidth",    "set line width", OFFSET(line_width), AV_OPT_TYPE_INT, {.str = "1"}, 0, INT_MAX, FLAGS },
    { "lw",    "set line width", OFFSET(line_width), AV_OPT_TYPE_INT, {.str = "1"}, 0, INT_MAX, FLAGS },
    { "space",    "set line space", OFFSET(space), AV_OPT_TYPE_INT, {.str = "0"}, 0, INT_MAX, FLAGS },
    { "offset",    "set wave offset from center", OFFSET(offset), AV_OPT_TYPE_INT, {.str = "0"}, INT_MIN, INT_MAX, FLAGS },
